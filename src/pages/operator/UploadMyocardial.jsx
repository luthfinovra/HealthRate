...
const UploadMyocardial = () => {
  return (
    <LayoutOperator>
      <div className="space-y-4">
        <div className="space-y-1 mb-5">
          <h1 className="font-semibold text-5xl">Upload Data Myocardial</h1>
        </div>
        <p className=" max-w-3xl font-normal text-[14px] text-[#2D3748] leading-[150%]">
          Myocardial Infarction adalah kondisi medis serius yang terjadi ketika
          aliran darah ke jantung terhambat, menyebabkan kerusakan pada otot
          jantung.
        </p>
...
export default UploadMyocardial;
